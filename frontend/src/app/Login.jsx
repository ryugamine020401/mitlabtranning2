...
export function LoginView() {
  ...
  return (
      ...
      <div className="w-full max-w-md space-y-6 bg-white p-6 rounded-lg shadow">
        <h1 className="text-2xl font-bold text-center">Product Expiration Date List</h1>
        ...
        <div className="text-center text-sm text-gray-600">
          ...
          <button onClick={() => dispatch(setView("signup"))} className="text-blue-500 hover:text-blue-600">
            Sign up
          </button>
        </div>
      </div>
